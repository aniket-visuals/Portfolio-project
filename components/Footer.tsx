...
import { Instagram, Send, ArrowUpRight, Linkedin } from 'lucide-react';

const Footer: React.FC = () => {
    return (
        <footer className="py-6 border-t border-white/5 bg-black">
            <div className="max-w-4xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <a href="https://www.instagram.com/aniket_visuals/" className="glass-panel p-3 rounded-lg flex items-center justify-between group hover:border-pink-500/50 transition-colors hover-trigger">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-gray-500">@aniket_visuals</p>
                        </div>
                    </div>
                    <ArrowUpRight className="text-gray-600 group-hover:text-pink-500 transition-colors w-3 h-3" />
                </a>
                <a href="https://t.me/aniket_visuals" className="glass-panel p-3 rounded-lg flex items-center justify-between group hover:border-blue-400/50 transition-colors hover-trigger">
                    <div className="flex items-center gap-3">
                ...
                <a href="https://www.linkedin.com/in/aniketvisuals/" className="glass-panel p-3 rounded-lg flex items-center justify-between group hover:border-blue-600/50 transition-colors hover-trigger">
                    <div className="flex items-center gap-3">
                        <div className="bg-white/10 p-1.5 rounded"><Linkedin className="w-3 h-3" /></div>
                        <div>
                            <p className="font-bold text-gray-400 group-hover:text-blue-600 transition-colors text-xs">LinkedIn</p>
                            <p className="text-[10px] text-gray-500"> Aniket visuals</p>
                        </div>
                    </div>
                    <ArrowUpRight className="text-gray-600 group-hover:text-blue-600 transition-colors w-3 h-3" />
                </a>
            </div>
